...
export const RECITERS: Reciter[] = [
  ...
  { id: 'taleeb', name: 'Ahmed Bin Taleb', url: 'https://server14.mp3quran.net/taleeb' },
  { id: 'ayyub', name: 'Muhammad Ayyub', url: 'https://server8.mp3quran.net/ayyub' },
  { id: 'lhdan', name: 'Muhammad Al-Luhaidan', url: 'https://server8.mp3quran.net/lhdan' },
];
